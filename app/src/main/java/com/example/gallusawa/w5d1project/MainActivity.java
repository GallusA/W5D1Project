package com.example.gallusawa.w5d1project;
...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, RadioGroup.OnCheckedChangeListener {
        ...
        mAuth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        //  display a message to the user if sign in failed
                        if (!task.isSuccessful()) {
    ...
    private MaskedWalletRequest generateMaskedWalletRequest(){
        ...
        // A publicKey for the purpose of this codelab.
                    ...
                    mAuth.createUserWithEmailAndPassword(email, password)
                            .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    // send the message to user if sign in failed
